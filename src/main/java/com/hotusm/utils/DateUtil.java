...
public final class DateUtil {
    ...
    /** 日期格式，yy: "yyyy" */
    public static final String yyyyStr = "yyyy";

    /** 日期格式，yy: "MM" */
    public static final String MMStr = "MM";

    /** 日期格式，yy: "dd" */
    public static final String ddStr = "dd";
    ...
    private static DateFormat yyyyMMddFormat1 = new SimpleDateFormat(yyyyMMddStr1);
    ...
    private static DateFormat yyyyFormat = new SimpleDateFormat(yyyyStr);
    private static DateFormat MMFormat = new SimpleDateFormat(MMStr);
    private static DateFormat ddFormat = new SimpleDateFormat(ddStr);
    ...
    public static synchronized String getDateNowYYYY() {
        Date date = new Date();
        if (date != null) {
    ...
    public static synchronized String getDateNowMM() {
        Date date = new Date();
        if (date != null) {
    ...
    public static synchronized String getDateNowDD() {
        Date date = new Date();
        if (date != null) {
     ...
     * 得到几分钟前后的时间
     */
    public static Date getTimeBeforeMinute(int minute) {
        Calendar calendar = Calendar.getInstance();
     ...
     * @return
     */
    public static Date getDateByStrYYYYMMDD1(String strDate) {
        if (strDate != null && !"".equals(strDate.trim())) {
            try {
                return yyyyMMddFormat1.parse(strDate);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
    ...
    public static void main(String[] args){
        Date date = DateUtil.getDateByStrYYYYMMDD1("2015/10/20");
    }
}
